...
required_files = [
    ...
    "inventories/sample/group_vars/all/00-required.yml",
    "inventories/sample/group_vars/all/10-assisted-installer.yml",
    "inventories/sample/group_vars/all/20-network.yml",
    "inventories/sample/group_vars/all/30-disconnected.yml",
    "inventories/sample/group_vars/all/40-bmc.yml",
    "inventories/sample/group_vars/all/50-runtime.yml",
