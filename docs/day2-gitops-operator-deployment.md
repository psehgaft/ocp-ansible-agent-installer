...
This is the canonical Task 2 workflow. Ansible selects and renders desired
...
uses a different name. The Task 1 release mirror and this Task 2 operator mirror
